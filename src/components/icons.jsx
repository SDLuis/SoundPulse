export const Pause = () => {
  return <svg version='1.0' xmlns='http://www.w3.org/2000/svg' className='fill-white' width='26' height='26' viewBox='0 0 60 60'><path d='M13.2 9.2c-1.7 1.7-1.7 39.9 0 41.6 1.6 1.6 8 1.6 9.6 0 1.7-1.7 1.7-39.9 0-41.6C22.1 8.5 20 8 18 8s-4.1.5-4.8 1.2zm24 0c-1.7 1.7-1.7 39.9 0 41.6 1.6 1.6 8 1.6 9.6 0 1.7-1.7 1.7-39.9 0-41.6C46.1 8.5 44 8 42 8s-4.1.5-4.8 1.2z' /></svg>
}
export const Play = () => {
  return <svg version='1.0' xmlns='http://www.w3.org/2000/svg' className='fill-white' width='26' height='22' viewBox='0 0 48 48'><path d='M8.6 5.5C6.2 8 6.2 40 8.6 42.5c1 .9 2.5 1.4 3.5 1.2 4-1.1 30-16 31-17.8.6-1.3.6-2.5 0-3.8-1-1.8-27-16.7-31-17.8-1-.2-2.5.3-3.5 1.2z' /></svg>
}
export const Left = () => {
  return <svg aria-hidden='true' className='cursor-pointer w-[10px] fill-white' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 256 512'><path d='M192 448c-8.188 0-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l137.4 137.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448z' /></svg>
}
export const Right = () => {
